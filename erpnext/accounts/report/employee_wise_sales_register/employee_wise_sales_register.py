...
def get_columns():
	return [
		...
		_("Attended By") + "Link/Attended By:100", 
...
def get_items(filters):
	...
	return frappe.db.sql("""select si_item.parent, si.posting_date, si.debit_to, si.project_name,
		si.customer, si.territory, si.base_net_total, si_item.item_code, si_item.item_name,
		si_item.item_group, si_item.sales_order, si.employee_name, si_item.income_account,
